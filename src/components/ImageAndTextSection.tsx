...
const defaultParagraph = "Solvalla Stall är ett familjärt stall på landet där gemenskap, glädje och omtanke om hästarna står i centrum. Vi erbjuder ridlektioner för alla nivåer, härliga skogsturer i natursköna omgivningar och en trygg miljö där både ryttare och hästar trivs."
